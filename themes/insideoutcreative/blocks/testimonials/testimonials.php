<?php
echo '<section class="position-relative content-section ' . get_field('classes') . '" style="padding:50px 0;' . get_field('style') . 'background:#505050;" id="' . get_field('id') . '">';
...
if(have_rows('testimonials_repeater')):
    ...
    echo '<div class="position-relative" style="color:#acacac;padding-left:3.5rem;">';
