...
$tabsCounter++;
    ...
    if (strstr($link_url, '#')) {
        echo '<span class="col-lg-3 col-md-4 text-center bold position-relative col-tabs" style="background:#dcdddf;color:#868686;text-decoration:none;padding:50px 0;">';
    } else {   
